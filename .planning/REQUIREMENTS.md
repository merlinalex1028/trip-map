...
- [x] **MAP-01**: 用户可以在桌面端和移动端看到一张可交互的世界地图主视图
- [x] **MAP-02**: 用户可以看到预置示例点位和已保存点位在地图上的高亮展示
...
- [x] **DRW-01**: 用户在桌面端通过右侧抽屉查看和编辑当前点位
- [x] **DRW-02**: 用户在移动端通过底部抽屉查看和编辑当前点位
- [x] **DRW-03**: 用户可以在详情面板中看到地点名称、所属国家或地区、地理坐标、简介和点亮状态
- [x] **DRW-04**: 用户可以通过关闭按钮或 `Esc` 键关闭详情面板

### Data & Persistence

- [x] **DAT-01**: 系统首次加载时可以读取项目内置的示例点位数据
...
*Last updated: 2026-03-24 after phase 06 audit traceability backfill*
