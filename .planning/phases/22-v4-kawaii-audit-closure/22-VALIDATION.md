...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 22-01-01 | 22-01 | 1 | STYLE-03, STYLE-04, STYLE-05, INTER-01, INTER-02, INTER-03 | T-22-01 | `20-VERIFICATION.md` 必须先建立 formal verification 骨架，frontmatter、六个一级段落、closure source 与 scope 边界都要锁定，且不得把旧 `drawer` wording 或未挂载组件写回范围 | docs + rg | `test -f .planning/phases/20-kawaii/20-VERIFICATION.md && rg -n "^phase: 20-kawaii$|^status: passed$|^score: 6/6 requirements satisfied$|^closure_source:$" .planning/phases/20-kawaii/20-VERIFICATION.md && rg -n "^## Goal Achievement$|^## Required Artifacts$|^## Key Link Verification$|^## Behavioral Spot-Checks$|^## Requirements Coverage$|^## Gaps Summary$" .planning/phases/20-kawaii/20-VERIFICATION.md && rg -n "20-VALIDATION.md|20-01-SUMMARY.md|20-02-SUMMARY.md|20-03-SUMMARY.md|20-04-SUMMARY.md" .planning/phases/20-kawaii/20-VERIFICATION.md && ! rg -n "drawer|BackendBaselinePanel|PosterTitleBlock" .planning/phases/20-kawaii/20-VERIFICATION.md` | ✅ `.planning/phases/20-kawaii/20-VALIDATION.md`, `.planning/phases/20-kawaii/20-01-SUMMARY.md`, `.planning/phases/20-kawaii/20-02-SUMMARY.md`, `.planning/phases/20-kawaii/20-03-SUMMARY.md`, `.planning/phases/20-kawaii/20-04-SUMMARY.md` | ⬜ pending |
| 22-01-02 | 22-01 | 1 | STYLE-03, STYLE-04, STYLE-05, INTER-01, INTER-02, INTER-03 | T-22-02 | `20-VERIFICATION.md` 的 evidence rows 必须逐条回链到真实 summary / validation / spec，并用最小 kawaii spec quick run 作为现时佐证；仅当 quick run 与既有 evidence 冲突时才升级 full suite 或新的人工复验 | docs + unit | `pnpm --filter @trip-map/web test -- src/App.kawaii.spec.ts src/components/map-popup/MapContextPopup.kawaii.spec.ts src/components/map-popup/PointSummaryCard.kawaii.spec.ts && rg -n "STYLE-03|STYLE-04|STYLE-05|INTER-01|INTER-02|INTER-03" .planning/phases/20-kawaii/20-VERIFICATION.md && test "$(rg -c "SATISFIED" .planning/phases/20-kawaii/20-VERIFICATION.md)" -ge 6 && rg -n "App.kawaii.spec.ts|MapContextPopup.kawaii.spec.ts|PointSummaryCard.kawaii.spec.ts|full suite|人工浏览器复验|orphaned|verification source" .planning/phases/20-kawaii/20-VERIFICATION.md` | ✅ `apps/web/src/App.kawaii.spec.ts`, `apps/web/src/components/map-popup/MapContextPopup.kawaii.spec.ts`, `apps/web/src/components/map-popup/PointSummaryCard.kawaii.spec.ts` | ⬜ pending |
