...
- [ ] **Phase 7: 城市选择与兼容基线** - 让城市成为稳定主选择结果，同时守住旧数据兼容与重复记录控制。
- [ ] **Phase 8: 城市边界高亮语义** - 用真实城市边界承接选中与保存结果，建立一致的区域表达。
...
- [ ] 07-04-PLAN.md — 用 coverage-audited 的离线城市目录替换 43 城样例库
- [ ] 07-05-PLAN.md — 让 lookup、search 与候选抽屉全部消费扩展目录并补齐 UAT 级回归
**UI hint**: yes
...
|-------|-----------|----------------|--------|-----------|
| 7. 城市选择与兼容基线 | v2.0 | 3/5 | In progress | - |
