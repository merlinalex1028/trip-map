import type { CanonicalPlaceSummary, ChinaAdminType } from '@trip-map/contracts'
...
export const canonicalPlaceCatalog: Record<CanonicalPlaceId, CanonicalPlaceSummary> = {
